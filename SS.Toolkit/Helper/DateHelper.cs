        ...
        public static string Parse(long value)
        {
            ...
            try
            {
                ...
                if (span.Days < 1)
                {
                    if (span.Hours >= 1)
                    {
                        retValue = string.Format("{0}小时前", span.Hours);
                    }
                    else if (span.Minutes > 0 && span.Minutes <= 60)
                    {
                        retValue = string.Format("{0}分钟前", span.Minutes);
                    }
                    else if (span.Seconds >= 0 && span.Seconds < 60)
                    {
                        retValue = string.Format("{0}秒前", span.Seconds);
                    }
                    else
                    {
                        retValue = dt.ToString(FORMAT);
                    }
        ...
        public static string FormatDate(DateTime value)
        {
            ...
            try
            {
                ...
                if (span.Days < 1)
                {
                    ...
                    {
                        retValue = value.ToString(FORMAT);
                    }
                }
                else
                {
